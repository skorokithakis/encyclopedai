"""
Django settings for encyclopedai project.
...
ALLOWED_HOSTS = ["*"] if os.getenv("NODEBUG") is None else [".stavros.io"]
...
MIDDLEWARE = [
    ...
    "encyclopedai.middleware.StatsMiddleware",
...
ROOT_URLCONF = "encyclopedai.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "encyclopedai.context_processors.settings",
            ]
        },
    }
]
...
WSGI_APPLICATION = "encyclopedai.wsgi.application"
